...
require_once 'minify/class-minify-group.php';
require_once 'minify/class-minify-groups-list.php';
require_once 'minify/class-minify-housekeeper.php';
require_once 'minify/class-minify-scanner.php';
