...
= 2.0.1 =
* [Fix] Add default gallery settings if they're not set
* [Fix] Return the cached video set when its first page total is lower than the last requested video index

= 2.0 =
* [New] Rewrite Vimeography Core and Renderer for Vimeography 2 compatibility
* [New] Added option to enable searching from within a gallery
* [New] You can now link directly to a video in a gallery
* [Tweak] Add clarification for the Videos Per Page setting.

= 1.1.2 =
* [Fix] Make sure download links display as expected with Vimeography 1.5.3
