<?php
/**
 * Template Name: Divisions - Videos (D4.1)
 */
?>
...
<?php while (have_posts()) : the_post(); ?>
  ...
  <?php // Slider area
    if( get_field('divisionVideos_slider') != '' ):
      $slider = get_field('divisionVideos_slider');
  ...
  ?>
    <section class="slider slider--division-videos <?php echo $divisionClass; ?>">
      <?php
  ...
  <?php // Breadcrumbs ?>
  <section class="breadcrumbs breadcrumbs--division-videos <?php echo $divisionClass; ?>">
  ...
  <div class="content-wrapper content-wrapper--content-general">
    <div class="content-wrapper content-wrapper-container--content-general">
      ...
      <?php // General Content
        if( get_field('divisionVideos_article') != '' ):
          $bodyContent = get_field('divisionVideos_article');
      ...
      <section class="sidebar sidebar--division-videos">
        <?php //Sub Pages Links
          $subPages = get_field('divisionVideos_subPages');
