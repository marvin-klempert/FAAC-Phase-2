...
<html <?php language_attributes(); ?>>
  ...
  ?>
  <section class="video-promotion video-promotion--division-news <?php echo $divisionClass; ?>">
  <?php
  ...
  ?>
  <section class="photo-promotion photo-promotion--division-news <?php echo $divisionClass; ?>">
  <?php
  ...
  // Footer Links
  ?>
   <section class="promotion-links promotion-links--division-news <?php echo $divisionClass; ?>">
    <?php
