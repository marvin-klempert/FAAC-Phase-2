...
<html <?php language_attributes(); ?>>
  ...
  ?>
  <section class="video-promotion video-promotion--homepage <?php echo $divisionClass; ?>">
  <?php
  ...
  ?>
  <section class="photo-promotion photo-promotion--homepage <?php echo $divisionClass; ?>">
  <?php
  ...
  // Footer Links
  ?>
  <section class="promotion-links promotion-links--homepage <?php echo $divisionClass; ?>">
  <?php
  ...
  <section class="homepage__footer <?php echo $divisionClass; ?>">
  <?php
