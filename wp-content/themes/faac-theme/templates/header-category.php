    ...
    <?php
      ...
      $categoryName = $category[0]->name;
        if( $categoryName == 'FAAC Commercial' ){
          $categoryName = 'faacCommercial';
        } elseif( $categoryName == 'FAAC Military' ){
          $categoryName = 'faacMilitary';
        } elseif( $categoryName == 'MILO Range' ){
          $categoryName = 'miloRange';
        ...
        $menuLogo = $categoryName . '_menuLogo';
        $menuNavigation = $categoryName . '_navigation';
        $menuHomepage = $categoryName . '_homepage';
        $menuDivision = $categoryName . '_name';
    ?>
