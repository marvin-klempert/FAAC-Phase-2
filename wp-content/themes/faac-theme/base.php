...
<html <?php language_attributes(); ?>>
  ...
  ?>
  <section class="video-promotion <?php echo $divisionClass; ?>">
  <?php
  ...
  ?>
  <section class="photo-promotion <?php echo $divisionClass; ?>">
  <?php
  ...
  // Footer Links
  ?>
   <section class="promotion-links <?php echo $divisionClass; ?>">
    <?php
