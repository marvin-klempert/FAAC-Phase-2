<?php get_template_part('templates/page', 'header'); ?>
  ...
  <section class="post-header">
    <img class="post-header post-header__image" src="<?php echo $headerBackground['url']; ?>" />
  ...
  <?php // Breadcrumbs ?>
  <section class="breadcrumbs breadcrumbs--category-archive <?php echo $divisionClass; ?>">
   ...
   <div class="content-wrapper content-wrapper--category-archive <?php echo $divisionClass; ?>">
    <div class="content-wrapper content-wrapper-container--category-archive <?php echo $divisionClass; ?>">



  <section class="posts posts--category-archive">
  ...
  <section class="sidebar sidebar--category-archive">
