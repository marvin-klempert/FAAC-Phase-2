...
<html <?php language_attributes(); ?>>
  ...
  <section class="testimonial testimonial--content-news">
    <?php //Testimonial
  ...
  ?>
  <section class="video-promotion video-promotion--content-news">
  <?php
  ...
  ?>
  <section class="photo-promotion photo-promotion--content-news">
  <?php
  ...
  <section class="promotion-links promotion-links--content-news">
  <?php
    // Promotion Links
