<?php
/**
 * Template Name: Content - Landing (7)
 */
?>
...
<?php while (have_posts()) : the_post(); ?>
  ...
  <?php // Slider area
    $slider = 'contentLanding_dynamicSlider';
  ...
  <?php // Intro Content w/ Image
    if( get_field('contentLanding_intro') != '' ):
      $introContent = get_field('contentLanding_intro');
  ...
  <?php // Secondary Content
    if( get_field('contentLanding_secondaryContent') != '' ):
      $secondaryContent = get_field('contentLanding_secondaryContent');
  ...
  <?php // Feature Block
    if( get_field('contentLanding_featureBlocks') != '' ):
      $featureBlocks = 'contentLanding_featureBlocks';
  ...
  <?php //Sector Solutions
    if( get_field('contentLanding_sectorSolutions') != '' ):
      $sectorSolutions = 'contentLanding_sectorSolutions';
  ...
  <?php //Sector Simulators
    if( get_field('contentLanding_sectorSimulators') != '' ):
      $sectorSimulators = 'contentLanding_sectorSimulators';
  ...
  <?php // Video Playlist
    $contentLanding_videos = 'contentLanding_videos';
      $videoPlaylist = $contentLanding_videos . '_videoPlaylist';
  ...
  <?php //Documentation Links
      $documentationLinks = get_field('contentLanding_documentation');
  ...
  <?php // Division promotion
    if( get_field('contentLanding_divisionPromo') != '' ):
      $divisionPromo = get_field('contentLanding_divisionPromo');
  ...
  <?php //Testimonial
    if( get_field('contentLanding_testimonial') != '' ):
      $testimonial = get_field('contentLanding_testimonial');
