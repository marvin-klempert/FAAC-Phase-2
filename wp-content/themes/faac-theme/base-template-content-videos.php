...
<html <?php language_attributes(); ?>>
  ...
  <section class="category-heading category-heading--content-news">
  ...
  <section class="category-row category-row--content-news">
  <?php //Category headings area
  ...
  <section class="testimonial testimonial--content-videos">
    <?php //Testimonial

      $testimonial = get_field('newsContent_testimonial');
  ...
  ?>
  <section class="video-promotion video-promotion--content-videos">
  <?php
  ...
  ?>
  <section class="photo-promotion photo-promotion--content-videos">
  <?php
  ...
  <section class="promotion-links promotion-links--content-videos">
  <?php
    // Promotion Links
