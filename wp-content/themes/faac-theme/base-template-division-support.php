...
<html <?php language_attributes(); ?>>
  ...
  ?>
  <section class="video-promotion video-promotion--division-general <?php echo $divisionClass; ?>">
  <?php
  ...
  ?>
  <section class="photo-promotion photo-promotion--division-general <?php echo $divisionClass; ?>">
  <?php
  ...
  // Footer Links
  ?>
   <section class="promotion-links promotion-links--division-general <?php echo $divisionClass; ?>">
    <?php
