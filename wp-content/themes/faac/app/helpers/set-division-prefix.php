<?php
/**
 * Sets the division prefix for the current page, for ACF purposes
 */
function set_division_prefix( $value = '' ) {

  //If no value is passed, fetch the proper one
  if( !$value ):
    $name = get_the_terms( get_the_ID(), 'division' )[0]->name;
  ...
  set_query_var( 'division-prefix', $value );
}